  ...
  return (
    <main className="bg-blue-100 min-h-screen p-12">
      <section className="container mx-auto">
        <h1 className="text-4xl flex justify-center cursive">Blog Posts Page</h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <article> 
            <Link to={"/post/" + post.slug.current} key={post.slug.current}>
              <span className="block h-64 relative roundded shadow leading-snug bg-white border-l-8 border-green-400 " key={index}>
                <img 
