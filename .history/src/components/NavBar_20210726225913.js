      ...
      <div className="container mx-auto flex justify-between ">
        <nav className="flex">
          <NavLink
            ...
            className="inline-flex items-center py-6 px-6 mr-4 ml-8 text-yellow-100 hover:text-red-800 text-4xl font-bold cursive tracking-widest"
          >
            Yupin
          </NavLink>
          <NavLink
            to="/post"
            className="inline-flex items-center py-3 px3 mr-6 my-6 rounded text-yellow-200 hover:text-green-800 "
